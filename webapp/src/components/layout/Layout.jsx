        ...
        <div className="flex items-center justify-between px-6 pb-2 pt-6 sm:px-10">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-[var(--navy-700)]">
              ...
              <span className="font-display text-[2rem] font-semibold tracking-[-0.04em]">faro</span>
            </div>
            <span className="h-5 w-px bg-[rgba(15,76,129,0.18)]" aria-hidden="true" />
            <p className="text-base font-medium tracking-[0.01em] text-[var(--ink-700)]">
