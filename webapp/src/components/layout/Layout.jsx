  ...
  return (
    <div className="min-h-screen w-full px-3 py-3 text-gray-900 selection:bg-brand-200 sm:px-5 sm:py-5">
      <main className="mx-auto flex min-h-[calc(100vh-1.5rem)] w-full max-w-6xl flex-col rounded-[30px] border border-white/70 shell-panel sm:min-h-[calc(100vh-2.5rem)]">
        <div className="flex flex-col gap-3 px-5 pb-2 pt-5 sm:flex-row sm:items-center sm:justify-between sm:px-10 sm:pt-6">
          <div className="flex min-w-0 items-start gap-3 sm:items-center">
            ...
            <p className="min-w-0 max-w-[12rem] text-[0.92rem] font-medium leading-tight tracking-[0.01em] text-[var(--ink-700)] sm:max-w-none sm:text-base sm:leading-normal">
              ruta guiada de acompa&ntilde;amiento
            </p>
          </div>
          <p className="navi-eyebrow self-center text-center sm:self-auto sm:text-right">Mentoría Estudiantil</p>
        </div>
